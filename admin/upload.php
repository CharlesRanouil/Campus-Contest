		  ...
		  <div class="col-md-10">
		  	...
		  	<div class="row">
		  		<div class="col-md-12 panel-warning">
						...
						if( !empty($_FILES['fichier']['name']) )
						{
							...
							if($infosImg[2] >= 1 && $infosImg[2] <= 14)
							{
									...
									&& UPLOAD_ERR_OK === $_FILES['fichier']['error'])
								{
									...
									echo $url;
									$sql = "INSERT INTO image (URL, description) VALUES('$url', '$desc')";
									mysqli_query($db,$sql);
						...
						<?php
							...
							<fieldset>
								...
								<p>
									...
									<input name="fichier" type="file" id="fichier_a_uploader" /><div style="width:70%;"><br>
									Description :
									<input class="form-control" id="desc" type="text" name="desc" ></div>
									<div style="width:20%; padding-top:10px;">
									<input type="submit" class="btn btn-primary btn-block" name="submit" value="Upload" /></div>
									</div>
								</p>
							</fieldset>
							</form> 	
					...
					<?php
                        $mysqli->real_query("SELECT * FROM image");
                        ...
                        while ($row = $res->fetch_assoc()) {
							...
							echo '</div>';
							echo '<img class="img_upload" src="../';
                            echo $row['URL'];
							echo '"alt="';
							echo $row['description'];
							echo '">';
							echo '<div class="url_img">';
							echo '<a title="';
							echo $row['description'];
							echo '" href="../';
							echo $row['URL'];
